...
FAILS=0
for t in test-docs test-version test-python test-preflight-classify test-doctor test-gate test-templates test-verify test-walkthrough test-telemetry test-ports test-stop test-segment1-mock test-archive; do
  echo "=== $t ==="
